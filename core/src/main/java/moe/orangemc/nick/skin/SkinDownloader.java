...
public class SkinDownloader {
    ...
    public SkinProperty fetchMojangSkin(String name) {
    ...
    public SkinProperty fetchLocalSkin(String name) {
    ...
    private SkinProperty fetchSkin(String uuidApi, String profileApi, String name, SkinSource source) {
        try {
